const en = {
  ...
  term: {
    ...
    export_b50_image: 'Export B50 Image',
    record_time: 'Time',
  ...
  message: {
    ...
    get_levels_success: 'Charts loaded',
    get_levels_failed: 'Failed to load charts',
    get_my_info_success: 'Profile loaded',
    token_expired: 'Session expired, please login again',
    get_record_success: 'Records loaded',
    ...
    upload_csv_info: 'Import scores in bulk via CSV. This will overwrite existing best scores. Do not modify fields other than scores.',
    ...
    export_csv_success: 'CSV exported',
